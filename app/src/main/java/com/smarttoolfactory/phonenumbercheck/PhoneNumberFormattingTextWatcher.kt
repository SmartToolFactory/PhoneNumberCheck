...
//        if (formatted != null) {
//            val rememberedPos: Int = mFormatter.rememberedPosition
//            mSelfChange = true
...
//        hasCursor: Boolean
//    ): String {
//        return if (hasCursor) mFormatter.inputDigitAndRememberPosition(lastNonSeparator) else mFormatter.inputDigit(
//            lastNonSeparator
//        )
//    }
//
